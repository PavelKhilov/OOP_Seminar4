...
public class Sample01 {
    public static void main(String[] args) {
        ...
        UniversalAccount universalAccount1 = new UniversalAccount("AA11BBB", 110.15);
        System.out.println(universalAccount1);
        UniversalAccount universalAccount2 = new UniversalAccount(5002, 110.15);
        System.out.println(universalAccount2);
        UniversalAccount universalAccount3 =
                new UniversalAccount(new CustomAccountIdentifier(111, "AA"), 110.15);
        ...
        Account<CustomAccountIdentifier> account1 =
                new Account<>(new CustomAccountIdentifier(111, "AA"), 110.15);
        CustomAccountIdentifier accountId1 = account1.getId();
        Account<String> account2 =
                new Account<>("AA11BBB", 110.15);
        Account<Integer> account3 =
                new Account<>(1133, 110.15);
        ...
        String[] newArray2 = ArrayUtils.<String>replaceTwoElementsV2(array2, 1, 2);
...
class UniversalAccount{
    ...
    UniversalAccount(Object id, double amount) {
        this.id = id;
        this.amount = amount;
    }
...
class SimpleAccount{
    ...
    SimpleAccount(int id, double amount) {
        this.id = id;
        this.amount = amount;
    }
