...
public class Sample02 {
    ...
    public static void main(String[] args) {
        ...
        DebetAccount<Entity> entityDebitAccount1 =
        ...
        Transaction<Account<?>> transaction1 = new Transaction<>(entityDebitAccount1, personCreditAccount1, 20000);
        transaction1.execute();

        transaction1 = new Transaction<>(entityDebitAccount1, personCreditAccount1, 30000);
        transaction1.execute();
